# 자이언트 특송사 API (GGATE API V2) — 접속 정보 메모
...
## 4. 주의 — 기획 문서와 다른 값 (2026-08-11 컬렉션 원본 대조)

`planning/planning_v5.html` · `planning/api_field_mapping.html` 기재값이 실제 규격과 다른 항목.

| 필드 | 기획 문서 기재 | **컬렉션 원본 (실제)** | 관세청 대응 필드 |
|---|---|---|---|
...
- **벌크 건수 상한 문서 내 충돌**: HWB 검색 설명은 "500건 초과 시 400 HWB_BULK_SIZE_EXCEEDED", 공통 에러표 `H004`는 "최대 1,000건". → 자이언트 확인 필요.
