...
$pilotInjector = Join-Path $PSScriptRoot 'dashboard\inject-user-pilot.ps1'
...
foreach ($required in @($coreBuilder, $personaBuilder, $pageBuilder, $pilotInjector, $singleFinalizer, $languageCleaner)) {
