...
<html lang="ko"><head>
  ...
  <main class="shell" id="main">
    ...
    <div class="accordion-stack">
      <details class="group" data-group="stages"><summary><span>실행 단계</span><small>현재 0단계 · 총 $($stages.Count)단계</small></summary><div class="group-body"><p class="group-note">기간보다 통과 기준이 우선입니다. 현재 단계만 기본으로 펼쳐집니다.</p>$($stageBuilder.ToString())</div></details>

      <details class="group" data-group="growth"><summary><span>광고와 B2B 전환</span><small>네이버 → Google → Meta → TikTok</small></summary><div class="group-body"><div class="plain-note">업무형 개인을 먼저 모으고, 실제로 반복 사용하는 사람만 팀·대행사 영업으로 연결합니다.</div><div class="budget" aria-label="초기 학습 예산 가설: 네이버 40, Google 30, Meta 20, TikTok 10"><span class="naver">네이버 40</span><span class="google">Google 30</span><span class="meta">Meta 20</span><span class="tiktok">TikTok 10</span></div>$($channelBuilder.ToString())<div class="flow-line"><span>검색·광고</span><i></i><span>첫 리포트</span><i></i><span>4주 반복</span><i></i><span>팀 영업</span></div></div></details>
